...
let BlogHttpService = class BlogHttpService {
    ...
    getAllBlogs() {
        ...
        let myResponse = this._http.get(this.baseUrl + '/all?authToken=' + 'YWFhODg5NGE0OWIzYTFkMmY3YWFkOWY5MjlmZTFkYTBhYzRiM2IyMmUxZTc4NGYzZjU2YjIxZTM2NGVhN2ZhN2NjMzJjNGYyMzE5YTNlMTkyNDQ3MDI4MmIyZWM4YTFjMTNhYTYyZGIxNDRjYzIzMTlkMjFhNzhiYmExMTJmNDMzOA==');
        console.log(myResponse);
        return myResponse;
    }
    getSingleBlogInformation(currentBlofId) {
        let myResponse = this._http.get(this.baseUrl + '/view' + '/' + currentBlofId + '?authToken=' + 'YWFhODg5NGE0OWIzYTFkMmY3YWFkOWY5MjlmZTFkYTBhYzRiM2IyMmUxZTc4NGYzZjU2YjIxZTM2NGVhN2ZhN2NjMzJjNGYyMzE5YTNlMTkyNDQ3MDI4MmIyZWM4YTFjMTNhYTYyZGIxNDRjYzIzMTlkMjFhNzhiYmExMTJmNDMzOA==');
        return myResponse;
    }
    createBlog(blogData) {
        console.log("http service routine is called");
        console.log(blogData);
        let myResponse = this._http.post(this.baseUrl + '/create' + '?authToken=' + 'YWFhODg5NGE0OWIzYTFkMmY3YWFkOWY5MjlmZTFkYTBhYzRiM2IyMmUxZTc4NGYzZjU2YjIxZTM2NGVhN2ZhN2NjMzJjNGYyMzE5YTNlMTkyNDQ3MDI4MmIyZWM4YTFjMTNhYTYyZGIxNDRjYzIzMTlkMjFhNzhiYmExMTJmNDMzOA==', blogData);
        console.log(myResponse);
        return myResponse;
    }
    deleteBlog(blogId) {
        ...
        let myResponse = this._http.post(this.baseUrl + '/' + blogId + '/delete' + '?authToken=' + 'YWFhODg5NGE0OWIzYTFkMmY3YWFkOWY5MjlmZTFkYTBhYzRiM2IyMmUxZTc4NGYzZjU2YjIxZTM2NGVhN2ZhN2NjMzJjNGYyMzE5YTNlMTkyNDQ3MDI4MmIyZWM4YTFjMTNhYTYyZGIxNDRjYzIzMTlkMjFhNzhiYmExMTJmNDMzOA==', data);
        return myResponse;
    }
    editBlog(blogId, blogData) {
        let myResponse = this._http.put(this.baseUrl + '/' + blogId + '/edit' + '?authToken=' + 'YWFhODg5NGE0OWIzYTFkMmY3YWFkOWY5MjlmZTFkYTBhYzRiM2IyMmUxZTc4NGYzZjU2YjIxZTM2NGVhN2ZhN2NjMzJjNGYyMzE5YTNlMTkyNDQ3MDI4MmIyZWM4YTFjMTNhYTYyZGIxNDRjYzIzMTlkMjFhNzhiYmExMTJmNDMzOA==', blogData);
        return myResponse;
    }
};
